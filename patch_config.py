...
from load_data import MaxProbExtractor_yolov2, MaxProbExtractor_yolov5, MeanProbExtractor_yolov5, \
    MeanProbExtractor_yolov2, MeanProbExtractor_yolo_ultralytics, MeanProbExtractor_fasterrcnn_mmdet3x
...
from ultralytics_model.yolo_detector import YOLODetector
from mmdetection import FasterRCNNDetector
...
class yolov5s(BaseConfig):
    ...
    def __init__(self):
        ...
        # 3080
        self.weights_yolov5 = 'weights/yolov5s.pt'
        self.data = '/home/ljw/yolov5/data/DOTA1_0.yaml'
...
class yolov5m(BaseConfig):
    ...
    def __init__(self):
        ...
        # 3080
        self.weights_yolov5 = 'weights/yolov5m.pt'
        self.data = '/home/ljw/yolov5/data/DOTA1_0.yaml'
...
class yolov5l(BaseConfig):
    ...
    def __init__(self):
        ...
        # 3080
        self.weights_yolov5 = 'weights/yolov5l.pt'
        self.data = '/home/ljw/yolov5/data/DOTA1_0.yaml'
...
class yolov5x(BaseConfig):
    ...
    def __init__(self):
        ...
        # 3080
        self.weights_yolov5 = 'weights/yolov5x.pt'
        self.data = 'DIOR.yaml'
...
class yolo_ultralytics(BaseConfig):
    """
    Reproduce the results from the paper: Generate a patch that minimises object score.
    """
    ...
    def __init__(self):
        ...
        # 3080
        self.weights_yolo = 'weights/yolov3u_best.pt'
        self.data = 'DIOR.yaml'
        ...
        self.classes = None  # filter by class: --class 0, or --class 0 2 3
        self.agnostic_nms = False  # class-agnostic NMS
        self.target_class = 2.0  # 指定类别

        self.model = YOLODetector(model_name="yolov3",
                                  checkpoint_path=self.weights_yolo,
                                  input_size=self.img_size,
                                  device=self.device,
                                  conf_thr=self.conf_thres,
                                  iou_thr=self.iou_thres)
        # self.prob_extractor = MaxProbExtractor_yolov5(0, 15, self.loss_target)
        self.prob_extractor = MeanProbExtractor_yolo_ultralytics(0, 20, self.loss_target, self.conf_thres, self.iou_thres,
                                                         self.max_det, self.target_class)
...
class faster_rcnn(BaseConfig):
    ...
    def __init__(self):
        ...
        # 3080
        self.checkpoint_file = 'weights/faster_rcnn_r50_fpn_1x_coco.pth'
...
class faster_rcnn_mmdet3x(BaseConfig):
    """
    Reproduce the results from the paper: Generate a patch that minimises object score.
    """
    ...
    def __init__(self):
        ...
        self.config_file = 'mmdetection/configs/faster_rcnn/faster-rcnn_r101_fpn_1x_dior.py'
        self.checkpoint_file = 'weights/fasterrcnn_epoch25.pth'
        ...
        self.model = FasterRCNNDetector(config_path=self.config_file, checkpoint_path=self.checkpoint_file, score_thr=self.conf_thres, device=self.device)

        self.prob_extractor = MeanProbExtractor_fasterrcnn_mmdet3x(0, 20, self.loss_target, self.conf_thres,
                                                                 self.iou_thres,
                                                                 self.max_det, self.target_class)
...
patch_configs = {
    ...
    "faster-rcnnmmdet3x": faster_rcnn_mmdet3x,
    "swin": swin,
    "ssd": ssd,
}
