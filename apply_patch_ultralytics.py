...
if __name__ == '__main__':
    config = patch_config.patch_configs['yolo_ultralytics']()
    model = config.model

    patch_path = "trained_patch/yolov3u_patch150_100_0.5_conf0.3_iou0.3_dlc.png"
    ...
    with open(asr_csv_path, "w", newline="", encoding="utf-8") as fcsv:
        ...
        for i_batch, (img_batch, lab_batch) in enumerate(train_loader):
            ...
            # 推理 + NMS
            output = model.get_predictions(p_img_batch)
